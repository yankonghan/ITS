...
namespace ITS_Manage.BLL
{
    ...
    {
        private readonly ITS_Manage.DAL.BusService dal = new ITS_Manage.DAL.BusService();
        public BusManage()
        { }
        #region  BasicMethod
        /// <summary>
        ...
        /// 得到一个对象实体，从缓存中
        /// </summary>
        public ITS_Manage.Model.Bus GetModelByCache(string busID)
        {

            string CacheKey = "BusModel-" + busID;
            ...
            return (ITS_Manage.Model.Bus)objModel;
        }
        ...
        /// 获得数据列表
        /// </summary>
        public List<ITS_Manage.Model.Bus> GetModelList(string strWhere)
        {
        ...
        /// 获得数据列表
        /// </summary>
        public List<ITS_Manage.Model.Bus> DataTableToList(DataTable dt)
        {
            List<ITS_Manage.Model.Bus> modelList = new List<ITS_Manage.Model.Bus>();
            int rowsCount = dt.Rows.Count;
            if (rowsCount > 0)
            {
                ITS_Manage.Model.Bus model;
        ...
        {
            return ITS_Manage.DAL.BusService.SelectBusArray(ChargeLineID);
        }
